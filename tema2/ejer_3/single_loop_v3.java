...
public class single_loop_v3 {
	public static void N_numbers(){
		int num=0;
		String str="";
		num=validators_v3.validator_int("¿Cuántos números quieres introducir? ","Introducir número");
		for(int i=0;i<num;i++) {
			//----------code
		}//end for
		str="";
	...
	public static void digits() {
		...
		String str,str_dig="";
		num=validators_v3.validator_int("Introduce un número: ","Introducir número");
		num_copy=num;
		while(num!=0) {
			digits = num%10;
			num=num/10;
